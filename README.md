...
## Morning Program : DevStar Challenge ##
+ [DevStar Lab](https://github.com/janleemans/devstarworkshop/blob/master/README.md) - Join a rebel squad, develop Microservices together and defeat the DevStar backend application
...
+ [AppDev Infrastructure lab](AppDev/AppDevInfra.md) - Use Docker Container to spin up any conainer from the Docker repository
